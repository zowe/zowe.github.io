...
{% if site.data.vnext_office_hours.consumers or site.data.vnext_office_hours.extenders %}
<section class="whitebackground">
  <div id="office-hours">
...
{% if site.data.vnext_faq.general or site.data.vnext_faq.extenders or site.data.vnext_faq.consumers %}
<section class="bluebackground">
