    ...
    <p class="card-text">You can download the build directly via the tarball, or as a cloud download from dockerhub. Separate downloads exist for z/Linux ("S390") and other Linux ("amd64" for intel & amd systems).</p>
        <div class="row">
          <div class="card-body">
            ...
            <p><a class="btn btn-primary" href="">Zowe {{ site.data.releases[0].zos_version }} amd64 tarball</a></p>  <!--{{ site.docker_download_url }}{{ site.data.releases[0].zos_version }}/zowe-v1-lts.amd64-{{ site.data.releases[0].zos_version }}.tar-->
            <p><a class="btn btn-primary" href="">Zowe {{ site.data.releases[0].zos_version }} s390x tarball</a></p>  <!--{{ site.docker_download_url }}{{ site.data.releases[0].zos_version }}/zowe-v1-lts.s390x-{{ site.data.releases[0].zos_version }}.tar-->
          </div>
          <div class="card-body">
