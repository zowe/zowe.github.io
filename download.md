    ...
    <div class="card bg-light border-light mb-3">
      ...
      <div class="card-body">
        ...
        <div class="row">
          ...
          <div class="card-body">
            <h5 class="card-title">PSWI build technical preview</h5>
            <p class="card-text">PSWI that can be registered in z/OSMF</p>
            <p class="card-text">Download the PSI</p>
            <p><a class="btn btn-primary" href="{{ site.psi_download_url }}">Zowe PSI 1.24.0 Technical Preview {{ site.zowe_fmid }}</a></p>
            <div>
