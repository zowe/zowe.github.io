...
<button><a href="{{ site.releases[0].cli_download_url }}">Zowe CLI (Stable)</a></button>
<button><a href="{{ site.releases[1].cli_download_url }}">Zowe CLI (Active Development)</a></button>
